...
const plugins = [
  { name: 'content-type-builder', dir: path.join(nodeModules, 'content-type-builder/dist/admin/translations') },
  { name: 'content-manager', dir: path.join(nodeModules, 'content-manager/dist/admin/translations') },
...
console.log('\nDone! Restart Strapi: cd aahome && npm run develop');
